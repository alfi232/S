                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-3 col-md-4">
                          <input type="text" id="mulai" name="mulai" class="form-control datepicker @error('mulai') is-invalid @enderror" placeholder="Mulai" value="{{old('mulai')}}" autocomplete="off" >
                              @error('mulai')
                              <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                              </span>
                        ...
                        <div class="col-sm-3 col-md-4">
                          <input type="text" id="selesai" name="selesai"  class="form-control datepicker @error('selesai') is-invalid @enderror" placeholder="selesai" value="{{old('selesai')}}" autocomplete="off" >
                              @error('selesai')
                              <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                              </span>
