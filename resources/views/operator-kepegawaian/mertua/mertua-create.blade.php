...
@section('title','Tambah Mertua Pegawai')
@section('content')
<section class="section">
    <div class="section-header">
        <ol class="breadcrumb justify-content-end h4">
            <li class="breadcrumb-item"><a href="">Pegawai</a></li>
            <li class="breadcrumb-item active" aria-current="page">Tambah data Mertua Pegawai</li>
        </ol>
    </div>
    @if (session('status'))
    ...
    <div class="section-body">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <form id="setting-form" method="POST" action="{{ route('pegawai-mertua.store') }}">
                  @csrf
                  <div class="card shadow" id="settings-card">
                    <div class="card-header">
                      <h4>Riwayat Mertua Pegawai</h4>
                    </div>
                    <div class="card-body">
                      ...
                      <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9">
                            <input type="text" id="tgl_lahir" name="tgl_lahir"  class="form-control datepicker @error('tgl_lahir') is-invalid @enderror" value="{{ old('tgl_lahir') }}" autocomplete="off" >
                            @error('tgl_lahir')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
