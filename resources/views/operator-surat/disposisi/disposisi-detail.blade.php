                ...
                <div class="row ">
                    <div class="col-md-8">
                        ...
                        <div class="form-group row mb-0">
                            <label for="staticEmail" class="col-sm-6 col-form-label">Instruksi / Informasi</label>
                            <label for="staticEmail" class="col-sm-6 col-form-label">Dilihat dan Disetujui Oleh</label>
                        </div>
                        @php
