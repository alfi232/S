...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="{{route('arsip-surat-keluar.index')}}">Arsip Surat Keluar</a></div>
            <div class="breadcrumb-item">Detail Arsip Surat Keluar </div>
        </div>
    </div>
    @if (session('status'))
    ...
    <div class="section-body">
        <div class="card shadow">
            <div class="card-header">
                <h4>Detail Arsip Surat Keluar</h4>
            </div>
            <div class="card-body">
                <div class="row ">
                    <div class="col-md-8">
                ...
                <a href="{{ route('arsip-surat-keluar.index') }}" class="btn btn-warning">
