...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Ubah Data Bagian</div>
        </div>
    </div>
                        ...
                        <form action="{{ route('bagian.update',$bagian->id_bagian) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('id_asisten') is-invalid @enderror" id="id_asisten" name="id_asisten">
                                    <option value="{{ $bagian->id_asisten }}"> {{ $bagian->nama_asisten }} </option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nama_bagian" name="nama_bagian"  class="form-control @error('nama_bagian') is-invalid @enderror" placeholder="Masukan Nama Staf Ahli" value="{{$bagian->nama_bagian}}" >
                                @error('nama_bagian')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
